...
<html>
  ...
  <body>
        ...
        <div class="container">
            ...
            <nav>
			  <ul>
				...
				<li><a href="indice.php">Español<a></li>
			</ul>
			</nav>
			<nav>
              <ul>
      ...
      <section id="showcase">
        <div class="container">
          <h1>Professional Delivery System</h1>
          <p>We Offer Delivery Services at a low price</p>
        </div>
      </section>
      ...
      <section id="boxes">
        <div class="container">
          <div class="box">
            ...
            <h3>Fast Deliver</h3>
            <p>Delivery on time guaranteed.</p>
          </div>
          <div class="box">
            <img src="./img/animatedtruck.jpg">
            <h3>Specialized in Fragile merchandise</h3>
            <p>Special equipment for fragile merchandise</p>
          </div>
          <div class="box">
            <img src="./img/moving.png">
            <h3>Professional Merchandise Handling</h3>
            <p>Professional loading and unloading</p>
          </div>
        </div>
      </section>
      <div id="footer">
